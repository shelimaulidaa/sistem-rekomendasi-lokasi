            ...
            <div class="block sm:hidden space-y-4">
                ...
                <div class="bg-white border border-gray-200 rounded-lg p-4 shadow-sm flex flex-col gap-3">
                    ...
                    <div class="flex items-center justify-end gap-2 mt-2 pt-3 border-t border-gray-100">
                        <a href="{{ route('manajer.users.edit', $user) }}" title="Edit" class="inline-flex items-center justify-center p-2.5 bg-amber-50 border border-amber-200 rounded-lg text-amber-600 hover:bg-amber-100 min-h-[44px] min-w-[44px] transition-colors">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex flex-row justify-end items-center gap-2">
                                    <a href="{{ route('manajer.users.edit', $user) }}" title="Edit" class="p-2 bg-amber-50 border border-amber-200 text-amber-600 hover:bg-amber-100 rounded-lg transition-colors inline-flex items-center justify-center">
