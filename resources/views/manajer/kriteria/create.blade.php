                ...
                <form method="POST" action="{{ route('manajer.kriteria.store') }}">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input id="kode_kriteria" type="text" name="kode_kriteria" value="{{ old('kode_kriteria') }}" required autofocus class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm transition-colors py-2 px-3 min-h-[44px]">
                        ...
                        <div>
                            ...
                            <input id="nama_kriteria" type="text" name="nama_kriteria" value="{{ old('nama_kriteria') }}" required class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm transition-colors py-2 px-3 min-h-[44px]">
