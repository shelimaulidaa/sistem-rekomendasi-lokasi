<x-app-layout>
    ...
    <div class="max-w-5xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <form method="POST" action="{{ route('manajer.observasi.store') }}" enctype="multipart/form-data"
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white overflow-hidden shadow-sm border border-gray-100 sm:rounded-xl"
                            x-data='wilayahManager({
                                initialProvId: @json(old("province_id", "")),
                                initialRegId: @json(old("regency_id", "")),
                                initialDistId: @json(old("district_id", "")),
                                selectedProvId: @json(old("province_id", "")),
                                selectedRegId: @json(old("regency_id", "")),
                                selectedDistId: @json(old("district_id", "")),
                                provName: @json(old("provinsi", "")),
                                regName: @json(old("kabupaten_kota", "")),
                                distName: @json(old("kecamatan", "")),
                                alamatLengkap: @json(old("alamat_lengkap", "")),
                                umk_kota: @json(old("umk", "")),
                                pdrb_kota: @json(old("pdrb", "")),
                                penduduk_muslim_kota: @json(old("jumlah_penduduk_muslim", ""))
                            })'
                        ...
                        <div class="bg-white overflow-hidden shadow-sm border border-gray-100 sm:rounded-xl">
                            <div class="px-6 py-4 border-b border-gray-100 bg-gray-50 flex items-center">
                                ...
                                <h3 class="text-lg font-bold text-base-dark">Informasi Survei</h3>
                            </div>
                        ...
                        <div class="bg-white overflow-hidden shadow-sm border border-gray-100 sm:rounded-xl">
                            ...
                            <div class="p-4 sm:p-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                                    <div>
                                        <label class="block text-sm font-medium text-base-dark mb-1">Nama Pemilik <span class="text-xs text-gray-400 font-normal"></span></label>
                                        <input type="text" name="nama_pemilik" value="{{ old('nama_pemilik') }}" placeholder="Opsional" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm py-2 px-3 min-h-[44px]">
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-base-dark mb-1">Nomor Telepon Pemilik <span class="text-xs text-gray-400 font-normal"></span></label>
                                        <input type="text" name="nomor_telepon_pemilik" value="{{ old('nomor_telepon_pemilik') }}" inputmode="numeric" oninput="this.value = this.value.replace(/[^0-9]/g, '')" placeholder="Opsional" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm py-2 px-3 min-h-[44px]">
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" inputmode="decimal" name="luas_bangunan" placeholder="ex. 120" value="{{ old('luas_bangunan') }}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1')" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm py-2 px-3 min-h-[44px]">
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-base-dark mb-1">Luas Tanah (m²)</label>
                                        <input type="text" inputmode="decimal" name="luas_tanah" placeholder="ex. 150" value="{{ old('luas_tanah') }}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1')" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm py-2 px-3 min-h-[44px]">
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-base-dark mb-1">Jumlah Lantai</label>
                                        <input type="number" name="jumlah_lantai" inputmode="numeric" placeholder="ex. 2" value="{{ old('jumlah_lantai') }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm py-2 px-3 min-h-[44px]">
                                    </div>

                                    <div>
                                        <label class="block text-sm font-medium text-base-dark mb-1">Jml Ruang Operasional</label>
                                        <input type="number" name="jumlah_ruangan" inputmode="numeric" placeholder="ex. 4" value="{{ old('jumlah_ruangan') }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm py-2 px-3 min-h-[44px]">
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-base-dark mb-1">Jumlah Kamar Mandi</label>
                                        <input type="number" name="jumlah_wc" inputmode="numeric" placeholder="ex. 2" value="{{ old('jumlah_wc') }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm py-2 px-3 min-h-[44px]">
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select name="kondisi_bangunan" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm py-2 px-3 min-h-[44px]">
                                            <option value="" {{ old('kondisi_bangunan') ? '' : 'selected' }}>Pilih Kondisi</option>
                                    ...
                                    <div>
                                        ...
                                        <select name="sumber_air" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm py-2 px-3 min-h-[44px]">
                                            <option value="" {{ old('sumber_air') ? '' : 'selected' }}>Pilih Sumber Air</option>
                                    ...
                                    <div>
                                        ...
                                        <select name="daya_listrik" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm py-2 px-3 min-h-[44px]">
                                            <option value="" {{ old('daya_listrik') ? '' : 'selected' }}>Pilih Daya Listrik</option>
                                    ...
                                    <div>
                                        ...
                                        <select name="area_parkir" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm py-2 px-3 min-h-[44px]">
                                            <option value="" {{ old('area_parkir') ? '' : 'selected' }}>Pilih Area Parkir</option>
                                    ...
                                    <div>
                                        ...
                                        <select name="lebar_jalan" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm py-2 px-3 min-h-[44px]">
                                            <option value="" {{ old('lebar_jalan') ? '' : 'selected' }}>Pilih Lebar Jalan</option>
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <select name="ventilasi" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm py-2 px-3 min-h-[44px]">
                                                <option value="" {{ old('ventilasi') ? '' : 'selected' }}>Pilih</option>
                                        ...
                                        <div>
                                            ...
                                            <select name="sirkulasi" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm py-2 px-3 min-h-[44px]">
                                                <option value="" {{ old('sirkulasi') ? '' : 'selected' }}>Pilih</option>
                                ...
                                <div>
                                    <label for="catatan" class="block text-sm font-medium text-base-dark mb-1">Catatan</label>
                        ...
                        <div class="bg-white overflow-hidden shadow-sm border border-gray-100 sm:rounded-xl">
                            ...
                            <div class="p-4 sm:p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div>
                                    ...
                                    <div class="space-y-3">
                                        <label class="flex items-center cursor-pointer p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                            ...
                                            <span class="ml-3 text-sm text-base-dark font-medium">Lokasi berada dekat dengan jalan utama</span>
                                        </label>
                                        <label class="flex items-center cursor-pointer p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                            ...
                                            <span class="ml-3 text-sm text-base-dark font-medium">Jalan menuju lokasi dapat dilalui kendaraan operasional (mobil box atau roda 4)</span>
                                        </label>
                                        <label class="flex items-center cursor-pointer p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                            ...
                                            <span class="ml-3 text-sm text-base-dark font-medium">Kondisi jalan menuju lokasi bagus / tidak rusak berat</span>
                                        </label>
                                        <label class="flex items-center cursor-pointer p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                            <input type="checkbox" name="mudah_ditemukan" value="1" {{ old('mudah_ditemukan') ? 'checked' : '' }} class="w-5 h-5 text-primary border-gray-300 rounded focus:ring-primary">
                                            <span class="ml-3 text-sm text-base-dark font-medium">Lokasi mudah ditemukan oleh Google Maps atau petunjuk arah</span>
                                        </label>
                                        <label class="flex items-center cursor-pointer p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                            <input type="checkbox" name="mudah_dijangkau" value="1" {{ old('mudah_dijangkau') ? 'checked' : '' }} class="w-5 h-5 text-primary border-gray-300 rounded focus:ring-primary">
                                            <span class="ml-3 text-sm text-base-dark font-medium">Lokasi mudah dijangkau oleh pelanggan</span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="space-y-3">
                                        <label class="flex items-center cursor-pointer p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                            <input type="checkbox" name="luas_mencukupi" value="1" {{ old('luas_mencukupi') ? 'checked' : '' }} class="w-5 h-5 text-primary border-gray-300 rounded focus:ring-primary">
                                            <span class="ml-3 text-sm text-base-dark font-medium">Luas bangunan mencukupi untuk mendukung aktivitas operasional</span>
                                        </label>
                                        <label class="flex items-center cursor-pointer p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                            ...
                                            <span class="ml-3 text-sm text-base-dark font-medium">Kondisi bangunan baik & siap digunakan (tidak perlu renovasi besar)</span>
                                        </label>
                                        <label class="flex items-center cursor-pointer p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                            ...
                                            <span class="ml-3 text-sm text-base-dark font-medium">Ventilasi & sirkulasi udara dalam bangunan memadai</span>
                                        </label>
                                        <label class="flex items-center cursor-pointer p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                            ...
                                            <span class="ml-3 text-sm text-base-dark font-medium">Tersedia fasilitas pendukung air bersih & listrik memadai</span>
                                        </label>
                                        <label class="flex items-center cursor-pointer p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                            <input type="checkbox" name="parkir_memadai" value="1" {{ old('parkir_memadai') ? 'checked' : '' }} class="w-5 h-5 text-primary border-gray-300 rounded focus:ring-primary">
                                            <span class="ml-3 text-sm text-base-dark font-medium">Tersedia area parkir mendukung aktivitas operasional</span>
                                        </label>
                                    </div>
                                </div>
                    ...
                    <div class="space-y-6">
                                ...
                                <template x-if="step === 2">
                                    <div x-data="imageUploader()" x-init="initUploader()" class="space-y-4">
                                        <div class="flex items-center justify-center w-full"
                                            ...
                                            <label for="fotos" class="flex flex-col items-center justify-center w-full h-48 border-2 border-dashed rounded-xl cursor-pointer transition-colors"
                                                ...
                                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                                    ...
                                                    <p class="text-xs text-gray-400">JPG, JPEG, PNG, WEBP (Maks 10 Foto, Maks @2MB, Total Maks: 7MB)</p>
                                                </div>
                                        ...
                                        <div x-show="totalSizeWarning" class="bg-red-50 text-red-600 text-sm px-4 py-3 rounded-lg border border-red-200" style="display: none;">
                                            Total ukuran file melebihi 7MB. Silakan kurangi ukuran foto atau hapus beberapa foto.
                                        </div>
                        ...
                        <div class="bg-white overflow-hidden shadow-sm border border-gray-100 sm:rounded-xl">
                            <div class="px-6 py-4 border-b border-gray-100 bg-gray-50 flex items-center justify-between">
                                <div class="flex items-center">
                                    <svg class="w-5 h-5 mr-2 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
                                    <h3 class="text-lg font-bold text-base-dark">Penilaian Kriteria</h3>
                                </div>
                                    ...
                                    @foreach($kriterias as $kriteria)
                                        <div class="p-4 rounded-xl border border-gray-200 bg-gray-50/50 hover:bg-white hover:shadow-xs transition-all">
                                                        ...
                                                        @for($skor = 1; $skor <= 5; $skor++)
                                                            <label class="inline-flex items-center cursor-pointer group">
                                                                <input type="radio" 
                                                                       ...
                                                                       value="{{ $skor }}" 
                                                                       {{ (old('kriteria_values.' . $kriteria->kriteria_id) == $skor) ? 'checked' : '' }}
                                            ...
                                            @elseif(strtolower($kriteria->jenis_input) === 'numeric')
                                                ...
                                                @php
                                                    $autoValue = old('kriteria_values.' . $kriteria->kriteria_id);
                                                    if ($autoValue === null && !empty($kriteria->kunci_observasi)) {
                                                        $autoValue = match ($kriteria->kunci_observasi) {
                                                            'biaya_sewa' => old('harga_sewa'),
                                                            'jumlah_kompetitor' => old('jumlah_kompetitor'),
                                                            'jarak_rph' => old('jarak_rph'),
                                                            default => null,
                                                        };
                                                    }
                                                @endphp
                                            ...
                                            @else
                                                ...
                                                <div class="mt-2 pt-2 border-t border-gray-200/80">
                                                    ...
                                                    <input type="text" 
                                                           ...
                                                           value="{{ old('kriteria_values.' . $kriteria->kriteria_id) }}" 
                                                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm py-2 px-3">
                                                </div>
                                            @endif
                                        </div>
                        ...
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="flex justify-between items-center mb-5">
                                ...
                                <div class="flex items-center space-x-4">
                                    <button type="button" x-show="!editingCompetitor" @click="editingCompetitor = { id: 'manual_'+Date.now(), nama: '', distance: '', rating: 0, isNew: true }; competitorModalError = '';" class="inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-primary text-base font-medium text-white hover:bg-primary-dark focus:outline-none sm:text-sm">
                                        + Tambah Kompetitor
                                    </button>
                                    <button type="button" @click="showCompetitorModal = false; competitorModalError = ''; editingCompetitor = null;" class="text-gray-400 hover:text-gray-500">
                                        ...
                                        <template x-for="(item, index) in competitorsList" :key="item.id">
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center space-x-2">
                                                    <button type="button" @click="editingCompetitor = { id: item.id, nama: item.nama, distance: item.distance, rating: item.rating, isNew: false }; competitorModalError = '';" class="text-yellow-600 hover:text-yellow-900 bg-yellow-50 px-3 py-1 rounded border border-yellow-200">Edit</button>
                            ...
                            <div x-show="editingCompetitor" style="display: none;" class="mt-4 space-y-4">
                                <template x-if="editingCompetitor">
                                    <div class="space-y-4">
                                        <div x-show="competitorModalError" class="bg-red-50 border-l-4 border-red-500 p-3 rounded-r-md">
                                            <div class="flex items-center">
                                                ...
                                                <p class="text-xs font-medium text-red-700" x-text="competitorModalError"></p>
                                            </div>
                                        </div>

                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-1">Nama Kompetitor *</label>
                                            <input type="text" x-model="editingCompetitor.nama" placeholder="Masukkan nama kompetitor" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm py-2 px-3">
                                        </div>
                                        <div class="grid grid-cols-2 gap-4">
                                            <div>
                                                <label class="block text-sm font-medium text-gray-700 mb-1">Jarak (KM) *</label>
                                                <input type="text" inputmode="decimal" x-model="editingCompetitor.distance" placeholder="0" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm py-2 px-3">
                                            </div>
                                            <div>
                                                <label class="block text-sm font-medium text-gray-700 mb-1">Rating</label>
                                                <input type="text" inputmode="decimal" x-model="editingCompetitor.rating" placeholder="-" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm py-2 px-3">
                                            </div>
                                        </div>
                                        <div class="flex justify-end space-x-3 pt-4 border-t border-gray-100">
                                            <button type="button" @click="editingCompetitor = null; competitorModalError = '';" class="px-4 py-2 bg-white border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50">Batal</button>
                                            <button type="button" 
                                                @click="
                                                    if (!editingCompetitor.nama || !editingCompetitor.nama.toString().trim()) {
                                                        competitorModalError = 'Nama kompetitor wajib diisi terlebih dahulu!';
                                                        alert('Nama kompetitor wajib diisi terlebih dahulu sebelum disimpan!');
                                                        return;
                                                    }
                                                    if (editingCompetitor.distance === null || editingCompetitor.distance === '' || editingCompetitor.distance === undefined || !editingCompetitor.distance.toString().trim()) {
                                                        competitorModalError = 'Jarak (KM) kompetitor wajib diisi terlebih dahulu!';
                                                        alert('Jarak (KM) kompetitor wajib diisi terlebih dahulu sebelum disimpan!');
                                                        return;
                                                    }
                                                    if (isNaN(parseFloat(editingCompetitor.distance.toString().replace(',', '.'))) || parseFloat(editingCompetitor.distance.toString().replace(',', '.')) < 0) {
                                                        competitorModalError = 'Jarak (KM) kompetitor harus berupa angka yang valid!';
                                                        alert('Jarak (KM) kompetitor harus berupa angka yang valid (>= 0)!');
                                                        return;
                                                    }
                                                    competitorModalError = '';
                                                    if (editingCompetitor.isNew) {
                                                        competitorsList.unshift(editingCompetitor);
                                                    } else {
                                                        let idx = competitorsList.findIndex(c => c.id === editingCompetitor.id);
                                                        if (idx !== -1) competitorsList[idx] = editingCompetitor;
                                                    }
                                                    competitorCount = competitorsList.length;
                                                    editingCompetitor = null;
                                                " 
                                                class="px-4 py-2 bg-primary border border-transparent rounded-md shadow-sm text-sm font-medium text-white hover:bg-primary-dark">
                                                Simpan
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div x-show="showRphModal" x-transition class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            ...
                            <div class="mt-4 space-y-4">
                                <div x-show="rphModalError" class="bg-red-50 border-l-4 border-red-500 p-3 rounded-r-md">
                                    <div class="flex items-center">
                                        <svg class="h-4 w-4 text-red-500 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd"/>
                                        </svg>
                                        <p class="text-xs font-medium text-red-700" x-text="rphModalError"></p>
                                    </div>
                                </div>
                        ...
                        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                            <button type="button" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-primary text-base font-medium text-white hover:bg-primary-dark focus:outline-none sm:ml-3 sm:w-auto sm:text-sm" 
                                @click="
                                    if (!rphName || !rphName.toString().trim()) {
                                        rphModalError = 'Nama RPH wajib diisi terlebih dahulu!';
                                        return;
                                    }
                                    if (jarakRphDisplay === null || jarakRphDisplay === '' || jarakRphDisplay === undefined || !jarakRphDisplay.toString().trim()) {
                                        rphModalError = 'Jarak RPH (KM) wajib diisi terlebih dahulu!';
                                        return;
                                    }
                                    if (isNaN(parseFloat(jarakRphDisplay.toString().replace(',', '.'))) || parseFloat(jarakRphDisplay.toString().replace(',', '.')) < 0) {
                                        rphModalError = 'Jarak RPH (KM) harus berupa angka yang valid!';
                                        return;
                                    }
                                    rphModalError = '';
                                    showRphModal = false;
                            ...
                            <button type="button" @click="if(rphList.length > 0) { rphName = rphList[0].nama; jarakRphDisplay = rphList[0].distance; rphModalError = ''; }" class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                                Reset ke Sistem
                            </button>
                        </div>
                    </div>
            ...
            <input type="hidden" name="latitude" id="hidden_lat" :value="lat">
            <input type="hidden" name="longitude" id="hidden_lng" :value="lng">
    ...
    @push('scripts')
    <!-- Alpine Create Observasi Form Logic -->
    <script>
        window.createObservasiForm = function createObservasiForm() {
            return {
                step: {{ $initialStep }},
                totalSteps: 2,
                ...
                rphName: @json(old('nearest_rph_name', '')),
                competitorCount: @json(old('jumlah_kompetitor') !== null && old('jumlah_kompetitor') !== '' ? (int)old('jumlah_kompetitor') : 0),
                spatialSearchRadius: 0,
                competitorsList: @json(old('competitors_data') ? json_decode(old('competitors_data'), true) : []),
                pendampingList: @json(old('anggota_pendamping', [])),
                rphList: [],
                ...
                rphModalError: '',
                isSubmitting: false,
                hargaSewaRaw: @json(old('harga_sewa', '')),
                jarakRphDisplay: @json(old('jarak_rph', '')),
                lat: @json(old('latitude', '')),
                lng: @json(old('longitude', '')),
                images: [],

                init() {
                    if (this.lat && this.lng) {
                        this.fetchSpatialData(this.lat, this.lng, false);
                    }
                },
                ...
                competitorsAvgRating() {
                    let rated = this.competitorsList.filter(c => c.rating !== null && c.rating !== '' && !isNaN(parseFloat(c.rating)));
                    if (rated.length === 0) return 0;
                    let sum = rated.reduce((acc, c) => acc + parseFloat(c.rating), 0);
                ...
                fetchSpatialData(lat, lng, forceOverwrite = true) {
                    if (!lat || !lng) return;
                    ...
                    fetch(`/api/spatial/analyze-location?latitude=${lat}&longitude=${lng}`)
                        ...
                        .then(data => {
                            if (forceOverwrite || !this.jarakRphDisplay) {
                            ...
                            if (data.competitors_list && data.competitors_list.length > 0) {
                                if (forceOverwrite || this.competitorsList.length === 0) {
                            ...
                            if (forceOverwrite || this.competitorCount === null || this.competitorCount === '' || this.competitorCount === undefined) {
                                this.competitorCount = this.competitorsList.length;
                            }
    ...
    <script>
        window.locationMap = function locationMap() {
            return {
                lat: @json(old('latitude', '')),
                lng: @json(old('longitude', '')),
                map: null,
                    ...
                    this.$nextTick(() => {
                        ...
                        if (typeof L.Control.Geocoder !== 'undefined') {
                            ...
                            .on('markgeocode', (e) => {
                                ...
                                this.updateMarker(latlng.lat, latlng.lng, true);
                            })
                            .addTo(this.map);
                        }
                ...
                updateMarker(lat, lng, doGeocode = false) {
                    ...
                    if(latInput) { latInput.value = this.lat; latInput.dispatchEvent(new Event('input', { bubbles: true })); }
                    if(lngInput) { lngInput.value = this.lng; lngInput.dispatchEvent(new Event('input', { bubbles: true })); }
