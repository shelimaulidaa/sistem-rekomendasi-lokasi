                            ...
                            <div class="p-4 sm:p-6 space-y-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                                    <div>
                                        ...
                                        <input id="tanggal_observasi" type="date" name="tanggal_observasi" value="{{ old('tanggal_observasi', $observasi->tanggal_observasi ? (\Carbon\Carbon::parse($observasi->tanggal_observasi)->format('Y-m-d')) : date('Y-m-d')) }}" required class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm py-2.5 px-3 min-h-[44px] bg-gray-50 text-gray-700">
                                    </div>
                                    <div>
                                        ...
                                        <input id="jam_observasi" type="time" name="jam_observasi" value="{{ old('jam_observasi', $observasi->jam_observasi ? substr($observasi->jam_observasi, 0, 5) : '') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm py-2.5 px-3 min-h-[44px] bg-gray-50 text-gray-700">
                                    </div>
                                </div>
                                </div>
                            </div>
                ...
                <div x-show="step === 2" x-cloak>
                        ...
                        <div class="bg-white overflow-hidden shadow-sm border border-gray-100 sm:rounded-xl">
                            ...
                            <div class="p-4 sm:p-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                                    ...
                                    <div>
                                        ...
                                        <select name="kondisi_bangunan" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm py-2 px-3 min-h-[44px]">
                                            ...
                                            <option value="Kurang" {{ old('kondisi_bangunan', $observasi->kondisi_bangunan) == 'Kurang' ? 'selected' : '' }}>Kurang</option>
                                            <option value="Buruk" {{ old('kondisi_bangunan', $observasi->kondisi_bangunan) == 'Buruk' ? 'selected' : '' }}>Buruk</option>
                                        </select>
                                    </div>
                                    <div>
                                        ...
                                        <select name="sumber_air" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm py-2 px-3 min-h-[44px]">
                                            ...
                                            <option value="Mata Air" {{ old('sumber_air', $observasi->sumber_air) == 'Mata Air' ? 'selected' : '' }}>Mata Air</option>
                                        </select>
                                    </div>
                                    <div>
                                        ...
                                        <select name="daya_listrik" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm py-2 px-3 min-h-[44px]">
                                            ...
                                            <option value="2200 VA" {{ old('daya_listrik', $observasi->daya_listrik) == '2200 VA' ? 'selected' : '' }}>2200 VA</option>
                                            <option value="3500 VA" {{ old('daya_listrik', $observasi->daya_listrik) == '3500 VA' ? 'selected' : '' }}>3500 VA</option>
                                            <option value="> 3500 VA" {{ old('daya_listrik', $observasi->daya_listrik) == '> 3500 VA' ? 'selected' : '' }}>> 3500 VA</option>
                                            <option value="Tidak Ada" {{ old('daya_listrik', $observasi->daya_listrik) == 'Tidak Ada' ? 'selected' : '' }}>Tidak Ada</option>
                                        </select>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select name="area_parkir" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm py-2 px-3 min-h-[44px]">
                                            ...
                                            <option value="Tidak Ada" {{ old('area_parkir', $observasi->area_parkir) == 'Tidak Ada' ? 'selected' : '' }}>Tidak Ada</option>
                                        </select>
                                    </div>
                                    <div>
                                ...
                                <div>
                                    ...
                                    <textarea id="catatan" name="catatan" rows="3" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 text-sm transition-colors py-2 px-3 min-h-[44px]">{{ old('catatan', $observasi->catatan) }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white overflow-hidden shadow-sm border border-gray-100 sm:rounded-xl">
                            ...
                            <div class="p-4 sm:p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div>
                                    ...
                                    <div class="space-y-3">
                                        <label class="flex items-center cursor-pointer p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                            <input type="checkbox" name="dekat_fasilitas" value="1" {{ old('dekat_fasilitas', $observasi->dekat_fasilitas) ? 'checked' : '' }} class="w-5 h-5 text-primary border-gray-300 rounded focus:ring-primary">
                                            <span class="ml-3 text-sm text-base-dark font-medium">Lokasi berada dekat dengan jalan utama</span>
                                        </label>
                                        <label class="flex items-center cursor-pointer p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                            <input type="checkbox" name="akses_roda4" value="1" {{ old('akses_roda4', $observasi->akses_roda4) ? 'checked' : '' }} class="w-5 h-5 text-primary border-gray-300 rounded focus:ring-primary">
                                        ...
                                        <label class="flex items-center cursor-pointer p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                            <input type="checkbox" name="jalan_bagus" value="1" {{ old('jalan_bagus', $observasi->jalan_bagus) ? 'checked' : '' }} class="w-5 h-5 text-primary border-gray-300 rounded focus:ring-primary">
                                            <span class="ml-3 text-sm text-base-dark font-medium">Kondisi jalan menuju lokasi bagus / tidak rusak berat</span>
                                        </label>
                                        <label class="flex items-center cursor-pointer p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                            <input type="checkbox" name="mudah_ditemukan" value="1" {{ old('mudah_ditemukan', $observasi->mudah_ditemukan) ? 'checked' : '' }} class="w-5 h-5 text-primary border-gray-300 rounded focus:ring-primary">
                                            <span class="ml-3 text-sm text-base-dark font-medium">Lokasi mudah ditemukan oleh Google Maps atau petunjuk arah</span>
                                        </label>
                                        <label class="flex items-center cursor-pointer p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                            <input type="checkbox" name="mudah_dijangkau" value="1" {{ old('mudah_dijangkau', $observasi->mudah_dijangkau) ? 'checked' : '' }} class="w-5 h-5 text-primary border-gray-300 rounded focus:ring-primary">
                                ...
                                <div>
                                    ...
                                    <div class="space-y-3">
                                        <label class="flex items-center cursor-pointer p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                            <input type="checkbox" name="luas_mencukupi" value="1" {{ old('luas_mencukupi', $observasi->luas_mencukupi) ? 'checked' : '' }} class="w-5 h-5 text-primary border-gray-300 rounded focus:ring-primary">
                                            <span class="ml-3 text-sm text-base-dark font-medium">Luas bangunan mencukupi untuk mendukung aktivitas operasional</span>
                                        </label>
                                        <label class="flex items-center cursor-pointer p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                            <input type="checkbox" name="bangunan_layak" value="1" {{ old('bangunan_layak', $observasi->bangunan_layak) ? 'checked' : '' }} class="w-5 h-5 text-primary border-gray-300 rounded focus:ring-primary">
                                            <span class="ml-3 text-sm text-base-dark font-medium">Kondisi bangunan baik & siap digunakan (tidak perlu renovasi besar)</span>
                                        </label>
                                        <label class="flex items-center cursor-pointer p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                            <input type="checkbox" name="ventilasi_baik" value="1" {{ old('ventilasi_baik', $observasi->ventilasi_baik) ? 'checked' : '' }} class="w-5 h-5 text-primary border-gray-300 rounded focus:ring-primary">
                                            <span class="ml-3 text-sm text-base-dark font-medium">Ventilasi & sirkulasi udara dalam bangunan memadai</span>
                                        </label>
                                        <label class="flex items-center cursor-pointer p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                            <input type="checkbox" name="air_listrik_memadai" value="1" {{ old('air_listrik_memadai', $observasi->air_listrik_memadai) ? 'checked' : '' }} class="w-5 h-5 text-primary border-gray-300 rounded focus:ring-primary">
                                            <span class="ml-3 text-sm text-base-dark font-medium">Tersedia fasilitas pendukung air bersih & listrik memadai</span>
                                        </label>
                                        <label class="flex items-center cursor-pointer p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                            <input type="checkbox" name="parkir_memadai" value="1" {{ old('parkir_memadai', $observasi->parkir_memadai) ? 'checked' : '' }} class="w-5 h-5 text-primary border-gray-300 rounded focus:ring-primary">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white overflow-hidden shadow-sm border border-gray-100 sm:rounded-xl">
                            ...
                            <div class="p-4 sm:p-6">
                                @if($observasi->dokumentasiLokasis && $observasi->dokumentasiLokasis->count() > 0)
                                    <div class="mb-6 border-b border-gray-100 pb-6" x-data="{ deletedPhotos: [] }">
                                        <label class="block text-sm font-bold text-base-dark mb-3">Foto Dokumentasi Tersimpan</label>
                                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                            @foreach($observasi->dokumentasiLokasis as $doc)
                                                <div class="relative group rounded-xl overflow-hidden border border-gray-200 shadow-sm aspect-square bg-gray-50 transition-all" x-show="!deletedPhotos.includes({{ $doc->foto_id }})">
                                                    <img src="{{ asset('storage/' . ltrim($doc->foto_path, '/')) }}" class="object-cover w-full h-full" alt="Foto Observasi" />
                                                    <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                                        <button type="button" @click="if(confirm('Hapus foto ini?')) { deletedPhotos.push({{ $doc->foto_id }}); }" class="bg-red-500 hover:bg-red-600 text-white rounded-full p-2 transition-transform transform scale-90 hover:scale-100 shadow-md" title="Hapus foto ini">
                                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
                                                        </button>
                                                    </div>
                                                    <template x-if="deletedPhotos.includes({{ $doc->foto_id }})">
                                                        <input type="hidden" name="delete_photos[]" value="{{ $doc->foto_id }}">
                                                    </template>
                                                </div>
                                            @endforeach
                                        </div>
    ...
    <script>
        window.editObservasiForm = function editObservasiForm() {
            return {
                ...
                rphModalError: '',
                isSubmitting: false,
                hargaSewaRaw: @json($formattedHargaSewa),
                jarakRphDisplay: @json($formattedJarakRph),
                lat: @json($formattedLat),
                lng: @json($formattedLng),
                images: [],
                ...
                fetchSpatialData(lat, lng, forceOverwrite = true) {
                    ...
                    fetch(`/api/spatial/analyze-location?latitude=${lat}&longitude=${lng}`)
                        .then(res => {
                            if (!res.ok) throw new Error('Spatial API response error');
                            return res.json();
                        })
                        .then(data => {
                            ...
                            if (forceOverwrite || !this.competitorCount) {
