    ...
    <x-slot name="header">
        <div class="flex items-center justify-between w-full">
            <div class="flex items-center space-x-3">
                <a href="{{ $backUrl ?? route('direktur.observasi.index') }}" class="text-gray-400 hover:text-primary transition-colors">
