            ...
            <div class="block sm:hidden space-y-4">
                ...
                <div class="bg-white border border-gray-200 rounded-xl p-4 shadow-sm flex flex-col gap-3">
                    ...
                    <div class="flex items-center justify-end pt-1">
                        <a href="{{ route('direktur.observasi.show', [$observasi, 'ref' => 'hasil']) }}" class="w-full inline-flex items-center justify-center px-3 py-2 bg-blue-50 border border-blue-200 text-blue-600 hover:bg-blue-100 rounded-lg text-xs font-bold transition-colors min-h-[44px]">
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="{{ route('direktur.observasi.show', [$observasi, 'ref' => 'hasil']) }}" title="Detail" class="p-2 bg-blue-50 border border-blue-200 text-blue-600 hover:bg-blue-100 rounded-lg transition-colors inline-flex items-center justify-center min-h-[38px] min-w-[38px]">
